 ...
 //generte TK
  ...
  //generate GPK
   public void  GenGPK() {
	...
	public usersk AcceptRegester(userinfo  UserInfo) {
		   Pairing pairing=SystemElement.pairing;
		   ...
		   StoreUserInfo(UserInfo,UserSk.K);
		   return   UserSk;
	}
	public void  StoreUserInfo(userinfo UserInfo,Element K) {
		
		MongoDb. StoreUserInfo(Host,  Port, DataBase,Collection,K, UserInfo);
